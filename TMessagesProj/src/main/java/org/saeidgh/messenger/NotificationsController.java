...
import org.saeidgh.Pouya.Helper.AnsweringMachine;
...
import org.saeidgh.ui.PopupNotificationActivity;
...
public class NotificationsController {
        ...
        notificationsQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    cv.put("tag", "org.saeidgh.messenger/org.saeidgh.ui.LaunchActivity");
                    cv.put("count", count);
    ...
    private void showExtraNotifications(NotificationCompat.Builder notificationBuilder, boolean notifyAboutLast) {
        ...
        for (int b = 0; b < sortedDialogs.size(); b++) {
            ...
            msgHeardIntent.setAction("org.saeidgh.messenger.ACTION_MESSAGE_HEARD");
            ...
            if (!ChatObject.isChannel(chat) && !AndroidUtilities.needShowPasscode(false) && !UserConfig.isWaitingForPasscodeEnter) {
                ...
                msgReplyIntent.setAction("org.saeidgh.messenger.ACTION_MESSAGE_REPLY");
